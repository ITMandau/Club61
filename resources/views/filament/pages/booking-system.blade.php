<div class="cmd-wrap" wire:poll.10s>
    ...
    <div class="cmd-header">
        ...
        <div style="display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap;">
            ...
            <a href="/admin/book-offline-court" class="cmd-btn-nav"
                style="background:#FAF5E8; border-color:#D4AF37; color:#8C6418; font-weight:800;">
    ...
    <div class="cmd-pulse-grid">
        ...
        <div class="cmd-kpi-card">
            <div>
                ...
                <div
                    style="width: 120px; height: 6px; background: #F3ECE0; border-radius: 9999px; margin-top: 0.5rem; overflow: hidden;">
                    <div
                        style="width: {{ min(100, $occupancyRate) }}%; height: 100%; background: linear-gradient(90deg, #D4AF37, #B38622); border-radius: 9999px;">
                    </div>
                </div>
            </div>
            <div
                style="width: 44px; height: 44px; border-radius: 12px; background: #FAF5E8; border: 1px solid #DEC898; display: flex; align-items: center; justify-content: center; color: #8C6418;">
        ...
        <div class="cmd-kpi-card">
            <div>
                <div class="cmd-kpi-val" style="color: #059669;">
                    {{ $activeCourtsNow }} <span style="font-size: 0.875rem; font-weight: 700; color: #6B7280;">/
                        {{ $totalCourtsCount }} Court</span>
                </div>
            ...
            <div
                style="width: 44px; height: 44px; border-radius: 12px; background: #ECFDF5; border: 1px solid #A7F3D0; display: flex; align-items: center; justify-content: center; color: #059669;">
                <svg style="width: 22px; height: 22px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="cmd-kpi-card">
            <div>
                <div class="cmd-kpi-val" style="color: #B45309;">
                    {{ $occupiedSlotsCount }} <span
                        style="font-size: 0.875rem; font-weight: 700; color: #6B7280;">Sesi</span>
                </div>
            ...
            <div
                style="width: 44px; height: 44px; border-radius: 12px; background: #FFFBEB; border: 1px solid #FDE68A; display: flex; align-items: center; justify-content: center; color: #B45309;">
                <svg style="width: 22px; height: 22px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="cmd-kpi-card"
            style="border-color: #A7F3D0; background: linear-gradient(135deg, #FFFFFF 0%, #F0FDF4 100%);">
            <div>
                <div class="cmd-kpi-val" style="color: #047857;">
                    {{ $freeSlotsCount }} <span
                        style="font-size: 0.875rem; font-weight: 700; color: #6B7280;">Jam</span>
                </div>
            ...
            <div
                style="width: 44px; height: 44px; border-radius: 12px; background: #D1FAE5; border: 1px solid #6EE7B7; display: flex; align-items: center; justify-content: center; color: #047857;">
                <svg style="width: 22px; height: 22px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="cmd-control-bar">
        ...
        <div style="display: flex; align-items: center; gap: 0.5rem; flex-wrap: wrap;">
            ...
            <button type="button" wire:click="today()"
                class="cmd-btn-nav {{ $isToday ? 'style=\"background:#FAF4E2; border-color:#D4AF37; font-weight:800;\"' : '' }}">
                <span>Hari Ini</span>
            </button>
        ...
        <div style="display: flex; align-items: center; gap: 1rem; flex-wrap: wrap;">
            ...
            <select wire:model.live="courtFilter"
                style="padding: 0.4rem 0.75rem; border: 1.5px solid #DEC898; border-radius: 10px; font-size: 0.75rem; font-weight: 700; color: #4A3A18; background: #FAF7F0;">
            ...
            <div style="display: flex; align-items: center; gap: 0.75rem; font-size: 0.6875rem; font-weight: 700;">
                ...
                <div style="display: flex; align-items: center; gap: 0.3rem;">
                    <span
                        style="width: 10px; height: 10px; border-radius: 3px; border: 1px dashed #DEC898; background: #FCFCFC;"></span>
                    <span style="color: #8C6418;">Slot Kosong (+)</span>
                </div>
                <div style="display: flex; align-items: center; gap: 0.3rem;">
                    <span
                        style="width: 10px; height: 10px; border-radius: 3px; border: 1px solid #E5E7EB; background: #F9FAFB;"></span>
    ...
    <div class="cmd-matrix-container">
        <div class="cmd-matrix-header">
            <div style="display: flex; align-items: center; gap: 0.5rem;">
                <svg style="width: 18px; height: 18px; color: #D4AF37;" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M4 6h16M4 10h16M4 14h16M4 18h16"></path>
                </svg>
                <span
                    style="font-size: 0.875rem; font-weight: 900; color: #1A150B; text-transform: uppercase; letter-spacing: 0.04em;">
                        ...
                        @foreach ($operationalHours as $opHour)
                            <th class="cmd-th-hour {{ $opHour['is_current'] ? 'is-live' : '' }}">
                                ...
                                @if ($opHour['is_current'])
                                    <div
                                        style="font-size: 0.5625rem; font-weight: 900; color: #B45309; text-transform: uppercase; margin-top: 0.1rem;">
                                        LIVE NOW
                                    </div>
                                @endif
                            </th>
                            ...
                            <td class="cmd-td-court">
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    <div>
                                        ...
                                        <div
                                            style="font-size: 0.6875rem; color: #8C6418; font-weight: 600; margin-top: 0.15rem;">
                                            {{ $court->type ?? 'Indoor' }} &bull; Rp
                                            {{ number_format($court->hourly_rate_regular, 0, ',', '.') }}/jam
                                        </div>
                                    </div>
                                    <span class="cmd-pill-gold"
                                        style="font-size: 0.5625rem; padding: 0.15rem 0.4rem;">
                            ...
                            @foreach ($operationalHours as $opHour)
                                ...
                                <td class="cmd-td-slot {{ $isLiveCol ? 'is-live-col' : '' }}">
                                    @if ($slot['type'] === 'booked')
                                        ...
                                        <div wire:click="inspectBooking('{{ $booking->id }}')"
                                            ...
                                            <div
                                                ...
                                                <span
                                                    style="font-weight: 800; font-size: 0.625rem; text-transform: uppercase;">
                                                    @if ($slot['is_playing'])
                                                        &bull; MAIN
                                                    @elseif($slot['is_paid'])
                                                        LUNAS
                                                ...
                                                <span
                                                    style="font-size: 0.5625rem; opacity: 0.85; font-family: monospace;">
                                                    {{ $booking->start_time->format('H:i') }}
                                                </span>
                                            </div>

                                            <!-- Middle: Player Name (Static Truncated) -->
                                            <div style="font-weight: 900; font-size: 0.75rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; display: block; max-width: 100%; margin: 0.15rem 0;"
                                            ...
                                            <div
                                                style="display: flex; justify-content: space-between; align-items: center; font-size: 0.5625rem;">
                                                <span style="font-family: monospace; opacity: 0.85;">
                                                    {{ substr($slot['booking_code'], -6) }}
                                                </span>
                                                @if ($slot['equipment_count'] > 0)
                                                    <span
                                                        style="padding: 0.05rem 0.3rem; border-radius: 4px; background: rgba(0,0,0,0.06); font-weight: 700;">
                                    ...
                                    @elseif($slot['type'] === 'closed')
                                        ...
                                        <div class="cmd-slot-box cmd-slot-past"
                                            title="Di luar jam operasional lapangan">
                                            <span
                                                style="font-size: 0.75rem; font-weight: 800; color: #9CA3AF;">-</span>
                                            <span
                                                style="font-size: 0.5625rem; font-weight: 700; color: #9CA3AF; text-transform: uppercase;">TUTUP</span>
                                        </div>
                                    @else
                                        @if ($slot['is_past'])
                                            <!-- Slot Jam Lewat (Disabled ala POS - Tidak Bisa Diklik) -->
                                            <div class="cmd-slot-box cmd-slot-past"
                                                title="Jam operasional telah lewat">
                                                <span
                                                    style="font-size: 0.75rem; font-weight: 800; color: #9CA3AF;">-</span>
                                                <span
                                                    style="font-size: 0.5625rem; font-weight: 700; color: #9CA3AF; text-transform: uppercase;">LEWAT</span>
                                            </div>
                                        @else
                                            ...
                                            <div wire:click="inspectEmptySlot('{{ $court->id }}', '{{ $h }}')"
                                                ...
                                                <svg style="width: 14px; height: 14px; opacity: 0.6;" fill="none"
                                                ...
                                                <span
                                                    style="font-size: 0.5625rem; opacity: 0.7;">{{ sprintf('%02d:00', $h) }}</span>
                                            </div>
                                        @endif
                                    @endif
                                </td>
        ...
        <div class="cmd-modal-backdrop" wire:click.self="closeInspector()">
            <div class="cmd-modal-content">
                @if ($inspectData['type'] === 'booking')
                    ...
                    <div
                        style="padding: 1.25rem 1.5rem; background: #FAF5E8; border-bottom: 1.5px solid #DEC898; display: flex; justify-content: space-between; align-items: center;">
                        <div>
                            <div style="display: flex; align-items: center; gap: 0.5rem;">
                                <span class="cmd-pill-gold">{{ $inspectData['court_name'] }}</span>
                                <span
                                    style="font-size: 0.75rem; font-weight: 800; color: {{ $inspectData['is_checked_in'] ? '#059669' : '#8C6418' }};">
                        ...
                        <button type="button" wire:click="closeInspector()"
                            style="background: none; border: none; font-size: 1.25rem; cursor: pointer; color: #8C6418; font-weight: 800;">
                            &times;
                        </button>
                    </div>
                    ...
                    <!-- Body Modal Booking -->
                    <div
                        style="padding: 1.5rem; display: flex; flex-direction: column; gap: 1rem; font-size: 0.8125rem;">
                        <!-- Grid Info -->
                        <div
                            style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem; background: #FAF8F2; padding: 1rem; border-radius: 14px; border: 1px solid #EADBBE;">
                            <div>
                                <div
                                    style="font-size: 0.6875rem; color: #7A6335; font-weight: 700; text-transform: uppercase;">
                                    Jadwal Bermain</div>
                                ...
                                <div style="font-size: 0.6875rem; color: #8C6418;">
                                    {{ $inspectData['date_formatted'] }}</div>
                            </div>
                            <div>
                                <div
                                    style="font-size: 0.6875rem; color: #7A6335; font-weight: 700; text-transform: uppercase;">
                                    Kode Tiket</div>
                                <div
                                    style="font-weight: 800; color: #1A150B; font-family: monospace; margin-top: 0.15rem;">
                        ...
                        <!-- Customer Contact -->
                        <div
                            style="display: flex; justify-content: space-between; align-items: center; padding: 0.75rem 1rem; background: #FFFFFF; border: 1px solid #EADBBE; border-radius: 12px;">
                            <div>
                                <div
                                    style="font-size: 0.6875rem; color: #7A6335; font-weight: 700; text-transform: uppercase;">
                                    Kontak Pemain</div>
                                <div style="font-weight: 800; color: #1A150B;">{{ $inspectData['customer_phone'] }}
                                </div>
                            </div>
                            @if ($inspectData['customer_phone'] && $inspectData['customer_phone'] !== '-')
                                ...
                                @endphp
                                <a href="https://wa.me/{{ $cleanPhone }}" target="_blank" class="cmd-btn-nav"
                        ...
                        @if (!empty($inspectData['equipments']))
                            <div
                                style="background: #FFFFFF; border: 1px solid #EADBBE; border-radius: 12px; padding: 0.75rem 1rem;">
                                <div
                                    style="font-size: 0.6875rem; color: #7A6335; font-weight: 800; text-transform: uppercase; margin-bottom: 0.5rem;">
                                ...
                                <div style="display: flex; flex-direction: column; gap: 0.35rem;">
                                    @foreach ($inspectData['equipments'] as $eq)
                                        <div
                                            ...
                                            <span style="font-weight: 700; color: #1A150B;">{{ $eq['quantity'] }}x
                                                {{ $eq['name'] }}</span>
                                            <span style="color: #8C6418;">Rp
                                                {{ number_format($eq['price'], 0, ',', '.') }}</span>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div style="display: flex; gap: 0.75rem; margin-top: 0.5rem;">
                            ...
                            @elseif($inspectData['is_checked_in'])
                                <button type="button" wire:click="executeComplete('{{ $inspectData['id'] }}')"
                                    class="cmd-btn-nav"
                                    style="flex: 1; justify-content: center; padding: 0.75rem; background: #ECFDF5; border-color: #10B981; color: #065F46; font-weight: 800;">
                                    <span>Tandai Sesi Selesai (Completed)</span>
                                </button>
                            @endif
                            <button type="button" wire:click="closeInspector()" class="cmd-btn-nav"
                ...
                @else
                    ...
                    <div
                        style="padding: 1.5rem; display: flex; flex-direction: column; gap: 1rem; font-size: 0.8125rem;">
                        <div
                            style="background: #F0FDF4; border: 1.5px solid #A7F3D0; padding: 1rem; border-radius: 14px; color: #065F46;">
                            <div style="font-weight: 800; font-size: 0.875rem;">Jadwal:
                                {{ $inspectData['time_label'] }}</div>
                            <div style="font-size: 0.75rem; margin-top: 0.2rem;">{{ $inspectData['date_formatted'] }}
                            </div>
                        ...
                        <div style="display: flex; gap: 0.75rem; margin-top: 0.5rem;">
                            <a href="/admin/book-offline-court" class="cmd-btn-primary"
                                style="flex: 1; justify-content: center; text-decoration: none; padding: 0.75rem;">
                ...
                <div style="padding: 1.5rem; display: flex; flex-direction: column; gap: 1rem;">
                    <form wire:submit.prevent="executeCheckIn(app(\App\Services\Padel\PadelBookingService::class))">
                        ...
                        <div style="display: flex; gap: 0.75rem; margin-top: 1rem;">
                            <button type="submit" class="cmd-btn-primary"
                                style="flex: 1; justify-content: center; padding: 0.75rem;">
                                <span>Verifikasi &amp; Check-In Gate</span>
                            </button>
                            <button type="button" wire:click="closeCheckInModal()" class="cmd-btn-nav"
                                style="padding: 0.75rem 1.25rem;">
                                <span>Batal</span>
                            </button>
                        </div>
                    ...
                    @if ($checkInResult)
                        <div
                            style="margin-top: 0.5rem; padding: 1rem; border-radius: 14px; background: {{ $checkInResult['already_checked_in'] ?? false ? '#FFFBEB' : '#ECFDF5' }}; border: 1.5px solid {{ $checkInResult['already_checked_in'] ?? false ? '#F59E0B' : '#10B981' }}; font-size: 0.8125rem;">
