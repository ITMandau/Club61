        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center gap-2 sm:gap-4">
                ...
                @if(Auth::check() && Auth::user()->canAccessPanel(\Filament\Facades\Filament::getPanel('admin')))
                    <a href="/admin" class="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#B8860B] text-[#1E1508] font-black text-xs uppercase tracking-wider shadow-sm hover:brightness-110 transition-all border border-[#F4E1B3]">
